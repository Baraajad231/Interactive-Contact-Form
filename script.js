...
//   // value تستخدم مع الinput+textarea للحصول على ما يدخله المستخدم
...
//     firstName.style.borderColor = "rgb(107, 105, 105)";
//   }
...
//     lastName.style.borderColor = "rgb(107, 105, 105)";
//   }

//   if (!emailAddress.value.trim()) {
//     event.preventDefault();
//     emailAddressErr.style.display = "block";
//     emailAddress.style.borderColor = "red";
//   } else if (!emailRegex.test(emailAddress.value.trim())) {
//     event.preventDefault();
//     emailAddressErr.style.display = "none";
//     emailAddressValidErr.style.display = "block";
//     emailAddress.style.borderColor = "red";
//   } else {
//     emailAddressErr.style.display = "none";
//     emailAddressValidErr.style.display = "none";
//     emailAddress.style.borderColor = "rgb(107, 105, 105)";
//   }

//   if (!requestType) {
//     event.preventDefault();
//     requestTypeErr.style.display = "block";
//   } else {
//     requestTypeErr.style.display = "none";
//   }
...
//     message.style.borderColor = "rgb(107, 105, 105)";
//   }

//   if (!checkboxConfirm.checked) {
//     event.preventDefault();
//     checkboxConfirmErr.style.display = "block";
//     checkboxConfirm.style.borderColor = "red";
//   } else {
//     checkboxConfirmErr.style.display = "none";
//     checkboxConfirm.style.borderColor = "rgb(107, 105, 105)";
//   }

//   if (
//     [...err].every((item) => item.style.display === "none") &&
//     emailAddressValidErr.style.display === "none"
//   ) {
